    ...
    <div class="collapse navbar-collapse snipcss0-0-0-1" id="navcol-1">
      ...
      <ul class="nav navbar-nav navbar-right snipcss0-1-1-3">
        ...
        <li class="dropdown snipcss0-2-3-6">
          <a data-toggle="dropdown" aria-expanded="true" href="materials.jsp" class="dropdown-toggle snipcss0-3-6-7">
            Material
            <span class="caret snipcss0-4-7-8">
            </span>
          </a>
           <li class="dropdown snipcss0-2-3-6">
          <a data-toggle="dropdown" aria-expanded="true" href="quiz.jsp" class="dropdown-toggle snipcss0-3-6-7">
            Quizes
            <span class="caret snipcss0-4-7-8">
            </span>
          </a>
            <li class="dropdown snipcss0-2-3-6">
          <a data-toggle="dropdown" aria-expanded="true" href="video.jsp" class="dropdown-toggle snipcss0-3-6-7">
            Videos
            <span class="caret snipcss0-4-7-8">
            </span>
          </a>
