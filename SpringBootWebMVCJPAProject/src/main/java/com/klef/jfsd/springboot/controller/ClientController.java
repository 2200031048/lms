...
public class ClientController 
{
  ...
  public ModelAndView viewCustomers() {
      List<Customer> customerList = adminService.getAllCustomers(); // Call your service method here
      ModelAndView mv = new ModelAndView("viewallcustomers"); // JSP or Thymeleaf template name
      mv.addObject("customerData", customerList); // Binding the data to the view
      return mv;
  }
  ...
  public ModelAndView about() {
      ModelAndView mv = new ModelAndView();
      mv.setViewName("about");  // Returns the about.jsp page
      return mv;
  }
  ...
  public ModelAndView privacy() {
      ModelAndView mv = new ModelAndView();
      mv.setViewName("privacy"); // This refers to a privacy.jsp file
      return mv;
  }
  ...
  public ModelAndView index() {
      ModelAndView mv = new ModelAndView();
      mv.setViewName("index"); // This refers to a privacy.jsp file
      return mv;
  }
	    ...
	    public ModelAndView features() {
	        ModelAndView mv = new ModelAndView();
	        mv.setViewName("features"); // This refers to features.jsp file
	        return mv;
	    }
...
//           emailService.sendEmail(emp.getEmail(),"Demo mail","Hi we are testing");
  ...
  public ModelAndView updateaction(HttpServletRequest request)
  {
   ...
   {
     String name = request.getParameter("name");
     String Gender = request.getHeader("employee name");
     String dob = request.getParameter("dob");
     String dept = request.getParameter("dept");
     String sal = request.getParameter("salary");
     double salary = Double.parseDouble(sal);
